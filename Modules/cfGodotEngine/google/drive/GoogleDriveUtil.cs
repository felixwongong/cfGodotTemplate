...
namespace cfUnityEngine.GoogleDrive
{
    ...
    {
        public static readonly ILogger unityLogger = new GodotLogger();
        ...
        public static IReadOnlyDictionary<string, FileHandler> MimeFileHandlers = new Dictionary<string, FileHandler>()
        {
            ...
            { "application/vnd.google-apps.folder", new FolderMimeHandler(unityLogger, ProjectSettings.GlobalizePath("res://")) },
        };
